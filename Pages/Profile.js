        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.profileHeader}>
                ...
                <View style={styles.profileInfo}>
                    <Image source={require('../assets/budi.jpg')} style={styles.profileImage} />
                    <View>
                        <Text style={styles.profileName}>Budi Setiawan</Text>
                        <Text style={styles.profileEmail}>budis9762@gmail.com</Text>
                    </View>
                </View>
            </View>
            <FlatList
